...
<table class="table table-hover table-bordered table-list">
    ...
    <tbody>
    <foreach>
        <?php if(is_array($rbac) || $rbac instanceof \think\Collection || $rbac instanceof \think\Paginator): $i = 0; $__LIST__ = $rbac;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
        <tr>
            <td><?php echo $vo['role_id']; ?></td>
            <td><?php echo $vo['role_name']; ?></td>
            <td><?php echo $vo['role_auth_ids']; ?></td>
            <td>
                <a href="<?php echo url('Rbac/roleedit',array('role_id'=>$vo['role_id'])); ?>">修改权限</a>
                <a class="js-ajax-delete" href="<?php echo url('Rbac/roledelete',array('role_id'=>$vo['role_id'])); ?>">删除</a>
            </td>
        </tr>
        <?php endforeach; endif; else: echo "" ;endif; ?>
    </foreach>
...
<div class="container py-2">
    <a class="btn btn-primary" role="button" href="<?php echo url('Rbac/add',array('role_id'=>$vo['role_id'])); ?>">添加权限</a>
</div>
