...
<form class="form-horizontal" action="<?php echo url('Rbac/authedit'); ?>" method="POST">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="auth_name" value="<?php echo $vo['auth_name']; ?>">
    </div>
    <label for="firstname" class="col-sm-2 control-label">控制器名</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" name="auth_c" value="<?php echo $vo['auth_c']; ?>">
    </div>
    <label for="firstname" class="col-sm-2 control-label">方法名</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" name="auth_a" value="<?php echo $vo['auth_a']; ?>">
    </div>
  </div>
  <?php endforeach; endif; else: echo "" ;endif; ?>
  ...
  <div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
      ...
      <a class="btn btn-primary" href="<?php echo url('Rbac/auth'); ?>">返回</a>
    </div>
  </div>
</form>
