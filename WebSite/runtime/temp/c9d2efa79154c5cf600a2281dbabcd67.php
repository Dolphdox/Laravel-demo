...
<table class="table table-hover table-bordered table-list">
    ...
    <foreach>
        ...
        <tr>
            ...
            <td>
                <a href="<?php echo url('Rbac/authedit',array('auth_id'=>$vo['auth_id'])); ?>">修改权限</a>
                <a class="js-ajax-delete" href="<?php echo url('Rbac/authdelete',array('auth_id'=>$vo['auth_id'])); ?>">删除</a>
            </td>
        </tr>
        <?php endforeach; endif; else: echo "" ;endif; ?>
    </foreach>
...
<div class="container text-center">
    ...
    <a class="btn btn-primary my-2 ju" role="button" href="<?php echo url('Rbac/authadd',array('auth_id'=>$vo['auth_id'])); ?>">添加权限</a>
</div>
