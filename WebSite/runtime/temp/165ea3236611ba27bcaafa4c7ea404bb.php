...
<form class="form-horizontal" action="<?php echo url('Rbac/roleedit'); ?>" method="POST">
  <?php if(is_array($edit) || $edit instanceof \think\Collection || $edit instanceof \think\Paginator): $i = 0; $__LIST__ = $edit;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
  <div class="form-group">
    <label for="firstname" class="col-sm-2 control-label">角色名</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" name="role_name" value="<?php echo $vo['role_name']; ?>">
    </div>
    <label for="firstname" class="col-sm-2 control-label">角色权限id</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" name="role_auth_ids" value="<?php echo $vo['role_auth_ids']; ?>">
    </div>
  </div>
  <?php endforeach; endif; else: echo "" ;endif; ?>
  ...
  <div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
      ...
      <a class="btn btn-primary" href="<?php echo url('Rbac/rbac'); ?>">返回</a>
    </div>
  </div>
</form>
