...
<form class="form-horizontal" action="<?php echo url('Rbac/edit'); ?>" method="POST">
  <div class="form-group">
    <label for="firstname" class="col-sm-2 control-label">新权限id</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" placeholder="请输入新权限id(2:帖子管理 3:普通用户)" name="role_id" value="">
      <input type="text" name="new_id" style="display: none;" value="<?php echo $id; ?>">
    </div>
  </div>
  <div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
      <button type="submit" class="btn btn-info">提交</button>
      <a class="btn btn-info" href="<?php echo url('Rbac/user'); ?>">返回</a>
    </div>
  </div>
</form>
